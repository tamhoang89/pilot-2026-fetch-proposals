# WFit - Walkers Stablecoin Gateway

> Multichain Onboarding, Stablecoin Payments,USDM and USDCx withdrawals
...
**Voluntary give-back pledge:** WFit will return **5% of net revenue generated directly by the Stablecoin Gateway** to the Cardano Treasury once the integration exceeds **100,000 ADA in cumulative stablecoin-related revenue**, continuing until a maximum of **50% of the original grant amount** has been returned. 
...
https://youtu.be/kIlwrwMB5EE

### Who else solves this today - competitors/alternatives, and why does your approach win?

Strava, Sweatcoin,StepN... focus on fitness tracking or activity rewards. DEXs, wallets and bridges solve liquidity and transfer needs, but the experience remains fragmented.

WFit combines these layers. We already have users, multichain payments and CNT's rewards. Our advantage is creating real stablecoin utility on Cardano. Users can enter from CEXs or other chains, use Credits across fitness, gaming and subscriptions, and settle through USDM/USDCx. Credit withdrawals are in USDM and USDCx.

Flow: Exchange or other blockchain (Eterium - USDT ,Solana - USDC,Abstract - USDCe/USDT,Injective - USDC ,Robinhood - USDCe,Sui - USDC ) → WFit onboarding route → Credits 1 USDC/USDT = 1 Credit → USDM or USDCx vault → WFit credit withdrawals in USDM or USDCx after usage in WFit.
...
Ivana Zafirovski - VCNFT Invest Dooel 

### What is your business model, and what keeps this running after the pilot? Who pays, and why does usage continue once grant funding ends?

WFit is built on recurring product usage, not grant-funded incentives. For four years, we have continued growing on Cardano through our own revenues. Income comes from subscriptions, Credits purchases, service/transaction fees, AI coaching, sponsored challenges, corporate wellness, WChronicles/TCG activity buying packs,trading in marketplace,playing battles,Ad spaces in app and our apps, sports registrations and partner commissions.

Users pay because Credits and stablecoins unlock real utility. Businesses and sponsors pay to run measurable campaigns and fund reward pools.

After the pilot, the Stablecoin Gateway becomes part of WFit’s existing economy: users continue buying Credits, subscriptions and TCG packs, trading, playing Battles, joining challenges and withdrawing USDM/USDCx. This funding accelerates stablecoin and credit-card payment integration alongside the new WFit App launch in September, followed by major promotion at our October Padel event with Web2 sponsors.
...
**The problem**\
\
The problem is not simply moving stablecoins liquidity to Cardano. The problem is what happens after they arrive, users need a simple way to enter Cardano, use stablecoins for real-world utility, and exit without needing to understand bridges, swaps, ADA fees or DeFi.

WFit does not operate a new bridge. It provides the application and payment layer that abstracts existing interoperability infrastructure from the end user

The relation between USDC/USDT Deposit → Credits → Asset verification → Stablecoin settlement → Credit issuance → WFit utility → Redemption → USDM/USDCx withdrawal\
\
WFit turns stablecoins from an asset people hold into money they can actually use, users don't enter Cardano simply to hold USDM or USDCx. They enter Cardano to use stablecoins for fitness, subscriptions, games, sports, rewards and digital products.

**The product**

WFit will build a stablecoin payments and settlement layer into the new WFit ecosystem.

The complete user journey will be:\
\
→ WFit onboarding route

→ Exchange or other blockchain

(Ethereum – USDT, Solana – USDC, Abstract – USDCe/USDT, Injective – USDC, Robinhood – USDCe, Sui – USDC)

→ Connect Wallet or send manually from CEX

→ Credits — 1 USDC/USDT = 1 Credit

→ USDM or USDCx vault

→ WFit credit withdrawals in USDM or USDCx after usage in WFit ecosystem.

The product will include six core components.

### Supporting links (repo, site, demo)

- https://walkerscardano.xyz/
- https://play.google.com/store/apps/details?id=com.walkers.walkerscnft&pli=1
- https://apps.apple.com/mk/app/walkerscnft/id6450308902
- https://chronicles.wfitapp.xyz/
- https://github.com/WalkersApp
...
WFit currently has a **USD 30,000 funded commitment from Cardano Builder DAO** for a separate 6-month project: the **Desktop Gamified Onboarding dApp (WBoard)**.

This funding supports a Web2-friendly desktop onboarding and engagement platform that connects users to the wider WFit ecosystem through wallet onboarding, profiles, social integrations, daily check-ins, XP, streaks, badges, achievements, airdrop tasks, staking, purchases and community challenges.

This commitment is **separate from the Stablecoin Gateway proposal**. Builder DAO funding is focused on user onboarding, gamification and retention, while this pilot focuses on **USDM/USDCx integration, multichain/CEX stablecoin flows, liquidity, Credits payments, subscriptions, rewards and stable withdrawals**. There is no duplicate funding between the two scopes.
