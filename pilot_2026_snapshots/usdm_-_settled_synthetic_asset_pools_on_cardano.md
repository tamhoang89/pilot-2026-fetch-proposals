...
-  Smart contracts and tests: 36,000
-  Transaction builder, quote engine, TypeScript SDK: 24,000
-  UI, admin tooling, public metrics: 18,000
-  External audit and remediation: 32,000
-  Documentation, integration package, launch and measurement: 10,000
