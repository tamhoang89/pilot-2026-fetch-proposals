# Stablecoin Settelment Engine for Inheritance Execution

> Engine that allows an easy Conversion of Cardano Native Assets into stablecoins to simplify Inheritance execution. Users Provide Stablecoins for aquiring bundles of Assets at a discount
...
- **Last finalized:** 2026-08-24T17:59:45.940000+00:00
...
GenWealth creates genuine stablecoin usage through inheritance and recovery auctions, that create incentives for users to acquire and use stablecoins
...
We target **600 transactions and 430 ADA in fees** from at least **60 independent external wallets**. We have 15 firms piloting this technology, with CNAs and tokenized RWA within their teams and with a small group of clients. We will reach to our 600+ waitlist, 80+ prior testers.

This solution can be used by anyone, looking for a direct system to liquidate CNAs into stablecoins

We expect between 25 to 35 auctions from our pilot firms each week, giving around 600 transactions per partners. \
\
We estimate average 3 bids per auction, with 2 settlement transactions, and a transaction returning each bid, as well as a registration transaction
...
**Professional partners:** We engaged 26 inheritance firms, with 15 available for pilots, plus law-firm and private-bank partners. They will pilot the technology, and are committed to generate a minimum number of auctions on Mainnet using CNAs and also tokenized RWAs. They have team members and clients participating

 We will recruit users through our Catalyst audience, Cardano community, social channels, and direct liquidity-provider outreach.
...
GenWealth combines both. Our **Settlement Auction Engine** integrates directly with the inheritance process, allowing authorized executors to liquidate inherited assets transparently on-chain, with non-custodial settlement directly in stablecoins. Additionally, it allows for liquiditation of asset bundles, and creates a need to provide stablecoin liquidity.
...
1)Update GenWealth contracts - 1 week - 16,667\
2)Auction contracts - 1.5 weeks - 16,667

3)Vault UI auction creation - 1.5 weeks - 16,667

4)Auction creation tx building-2 weeks - 16,667

5) Public auction miniapp - 4 weeks - 33,333

6) Pilots, Marketing, Testing & fixes - 6 weeks - 50,000

This funding accelerates both delivery and genuine external-user stablecoin demand and activity on Cardano.
...
\- Deploy updated GenWealth contracts with executor-authorized liquidation and verified-stablecoin settlement.
...
GenWealth is building a **non-custodial Stablecoin Settlement Engine** that allows assets inherited through a GenWealth vault to be transparently converted into stablecoins on Cardano.
